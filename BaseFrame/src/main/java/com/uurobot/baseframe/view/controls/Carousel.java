package com.uurobot.baseframe.view.controls;
...
public class Carousel extends CarouselSpinner implements GestureDetector.OnGestureListener {
         ...
         * The axe angle
         */
        private float mTheta = (float) (25.0f * (Math.PI / 180.0));
        ...
        private class ImageAdapter extends BaseAdapter {
                ...
                private int[] drawables = {R.drawable.cat, R.drawable.hippo, R.drawable.monkey, R.drawable.mouse, R.drawable.panda, R.drawable.rabbit};
                ...
                public void SetImages(TypedArray array, TypedArray names, boolean reflected) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                                Bitmap originalImage = BitmapFactory.decodeResource(getResources(), drawables[i]);
                                Log.e(TAG, "SetImages: =================" + originalImage.getWidth() + "    " + originalImage.getHeight());
                                if (reflected) {
