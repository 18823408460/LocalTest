...
/**
 * Window.Callback == 接受屏幕的触摸事件
 * <p>
 * KeyEvent.Callback == 接受键盘信息
 */
public class UIAlertView implements KeyEvent.Callback, Window.Callback {
        private Activity mContext;
        private FrameLayout mDecorView;
        private View dialog_alert_root_Layout;
        private View content_Layout;
        private Window xWindow;
        private LayoutInflater layoutInflater;
        private FrameLayout dialot_alert_content_layout;
        ...
        public UIAlertView(Context pContext) {
                ...
                mDecorView = (FrameLayout) xWindow.getDecorView().findViewById(android.R.id.content);
                initRootView();
        }

        private void initRootView() {
                dialog_alert_root_Layout = layoutInflater.inflate(R.layout.layout_ui_alert_root, mDecorView, false);
                dialot_alert_content_layout = (FrameLayout) dialog_alert_root_Layout.findViewById(R.id.alert_content);
                View v = dialog_alert_root_Layout.findViewById(R.id.alert_root);
                ...
                lParams.setMargins(
                        ...
                        0);
                dialot_alert_content_layout.setLayoutParams(lParams);
        }
        ...
        private void initAlert() {
                content_Layout = layoutInflater.inflate(R.layout.layout_ui_alert, null, false);
                ...
                TextView titleTv = (TextView) content_Layout.findViewById(R.id.title);
                ...
                TextView msgTv = (TextView) content_Layout.findViewById(R.id.message);
                ...
                TextView cancelTv = (TextView) content_Layout.findViewById(R.id.cancel);
                ...
                View spline = content_Layout.findViewById(R.id.spline);
                TextView okTv = (TextView) content_Layout.findViewById(R.id.ok);
                if (okAlertItem != null) {
                ...
                content_Layout.startAnimation(anim);

                //将
                dialot_alert_content_layout.addView(content_Layout);
        }

        public UIAlertView show() {
                if (mDecorView != null && !isShowing()) {
                        mDecorView.addView(dialog_alert_root_Layout);
        ...
        private void dismiss() {
                if (mDecorView != null && mDecorView.findViewById(R.id.alert_root) != null) {
                        Animation anim = AnimationUtils.loadAnimation(mContext, R.anim.fade_out_center);
                        if (content_Layout != null) content_Layout.startAnimation(anim);
                        anim.setAnimationListener(new Animation.AnimationListener() {
                                ...
                                public void onAnimationEnd(Animation pAnimation) {
                                        if (dialog_alert_root_Layout != null) {
                                                ((ViewGroup) dialog_alert_root_Layout).removeView(content_Layout);
                                        }

                                        if (mDecorView != null) {
                                                mDecorView.removeView(dialog_alert_root_Layout);
                                        }
        ...
        private boolean isShowing() {
                if (mDecorView != null)
                        return mDecorView.findViewById(R.id.alert_root) != null;
                else
                        return false;
        }
