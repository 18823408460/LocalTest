...
public class SmartDoctorUpDialog extends DialogFragment {
        private static final String Args_Msg = "Args_Msg";
        private String showMsg;

        public static SmartDoctorUpDialog getInstance(String showMsg) {
                SmartDoctorUpDialog smartDoctorDialog = new SmartDoctorUpDialog();
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
                View inflate = inflater.inflate(R.layout.dialog_smartdoctor_up, container);
